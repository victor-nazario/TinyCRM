...
public class OpportunityController extends CRMController {
	//Definition of super constructor
		...
		public void validateEmail() {
			...
			String emailInput = ((OpportunityTCRMView) getView()).getTextEmail(); 
		...
		public void validateWebsite() {
			...
			String WebsiteInput = ((OpportunityTCRMView) getView()).getTextWebsite(); 
		...
		public void validateFacebook() {
			String FacebookInput = ((OpportunityTCRMView) getView()).getTextFacebook(); 
			String alphaNumericPattern  = "[a-zA-Z ]*";
